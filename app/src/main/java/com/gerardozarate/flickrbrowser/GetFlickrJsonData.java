...
class GetFlickrJsonData extends AsyncTask<String, Void, List<Photo>> implements GetRawData.OnDownloadComplete {
    ...
    public GetFlickrJsonData(String baseURL, String langugage, boolean matchAll, OnDataAvailable callBack) {
        Log.d(TAG, "GetFlickrJsonData: Called");
        mBaseURL = baseURL;
        mLangugage = langugage;
        mMatchAll = matchAll;
        mCallBack = callBack;
    }
    ...
    void executeOnSameThread(String searchCriteria){
        ...
        String destinationUri = createUri(searchCriteria, mLangugage, mMatchAll);
    ...
    protected List<Photo> doInBackground(String... params) {
        ...
        String destinationUri = createUri(params[0], mLangugage, mMatchAll);
    ...
    public void onDownloadComplete(String data, DownloadStatus status) {
        ...
        if(status == DownloadStatus.OK){
            ...
            try{
                ...
                Log.e(TAG, "onDownloadComplete: ERror parsing json data " + jsone.getMessage());
